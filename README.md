...
At the moment it is a work-in-progress tutorial mainly applicable for use on the hcux400 HPC at Teagasc but the general code should work on other machines (just modify the ```module load``` lines and make sure the executables and databases are in your path).  
